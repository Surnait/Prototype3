...
public class AnimatedPlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Stop the Dust Cloud when the game starts
        dustCloud.Stop();
    }
    ...
    void Update()
    {
        ...
        transform.Translate(Vector3.forward * Time.deltaTime * moveSpeed * verticalInput*-1);

        //Activate Run or Idle Animation
        animator.SetFloat("verticalInput", Mathf.Abs(verticalInput));
        
        //Activate or Deactivate the Dust Cloud
